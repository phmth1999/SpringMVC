...
Validator.checkUsernameExist = function(selector, message) {
	return {
		selector : selector,
		test : function(value) {
			let res = "";
			...
			return res!="Duplicate" ? undefined : message || 'Username đã tồn tại';
		}
	};
}
Validator.checkPhoneExist = function(selector, message) {
	return {
		selector : selector,
		test : function(value) {
			let res = "";
			...
			return res!="Duplicate" ? undefined : message || 'Phone đã tồn tại';
		}
	};
}
